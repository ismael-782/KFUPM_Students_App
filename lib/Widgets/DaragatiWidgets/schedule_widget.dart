...
import 'package:flutter_tournament/Screens/course_descreption.dart';
import 'package:google_fonts/google_fonts.dart';



class ScheduleWidget extends StatelessWidget {
  const ScheduleWidget({super.key, required this.selectedSchedule});
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => DescriptionPage(
                              scheduleInfo: selectedSchedule[index],
                            ),
                          ),
                        );
                      },
